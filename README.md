...
### Install geth for coin, this is included in the node directory, 
    $ fresh download can be found on akroma.io

### Install  Pool

    $ git clone https://github.com/phatblinkie/akroma.cryptopools.info.git
    $ cd akroma.cryptopools.info
    $ make all
    $ ls build/bin/
...
### Run the service installer
  ...
  $  //the default name of the built pool binary, it will rename it to akroma for you.
...
You can open firewall by opening 80,443,8009,8004,8002.

## Install Frontend

### Modify configuration file

    $ nano akroma.cryptopools.info/www/config/environment.js
...
The frontend is a single-page Ember.js application that polls the pool API to render miner stats.
    ...
    $ cd akroma.cryptopools.info/www
    ...
    $ bower install
    $ ./build.sh
    $ note: the build script copies the contents of akroma.cryptopools.info/www/dist/ to ~/www
...
PIRL/akroma/eth or any ethash coin: 0x4bc7b9d69d6454c5666ecad87e5699c1ec02d533
